      ...
      <div class="rt_content">
        ...
        <table class="table table-bordered">
          ...
          <tr>
            ...
            <td style="text-align: center;">{{line_group.provinceName}}{{line_group.cityName}}</td>
            ...
            <td class="center">
              ...
              <router-link :to="{path:'leader_user',query:{line_groupId:line_group.id}}" title="编辑"  style="color: #c12e2a;font-size: 25px"><img style="width: 30px;height: 30px;    display: inherit;" src="@/assets/images/chakan2.png"></router-link>
              <a  title="查看" data-toggle="modal"
                  data-target="#seeScenic"  style="color: #ff79c6;font-size: 29px"  @click="getScenic(line_group)"><img style="width: 35px;height: 35px;    display: inherit;" src="@/assets/images/chakan.png"></a>
            </td>
          </tr>
          </tbody>
              ...
              <div class="modal-body">
                <form  method="post" name="travel-cus" class="cusForm">
                  ...
                  <ul class="cus-table">
                    ...
                    <li style="margin-top: 2%">
                      <label style="width: 98px">  出发城市：</label>
                      <el-input style="font-weight: 100;width: 60%;" readonly="readonly" :value="line_group.cityName"></el-input>
                    </li>
                    <li style="margin-top: 2%">
  ...
  export default {
    ...
    methods:{
      ...
      dataListFn: function(index){
        ...
        this.$axios.post("line_group/leader_list",qs.stringify(this.searchDate),config)
          .then(result=>{
            var data = result.data;
            this.line_groupList=[];
            this.line_groupList=data.lineGroupList;
...
//根据点击页数请求数据
      ...
      initLeader() {
        ...
        this.$axios.get("leader/getLeader")
          .then(result=>{
            var data = result.data;
           this.leader=data.leader;
           this.searchDate.leaderId=data.leader.leaderId;
           this.init();
          })
          .catch(failResponse=>{
            alert('数据加在错误...正在重新载入')
