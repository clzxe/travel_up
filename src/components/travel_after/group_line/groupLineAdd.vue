<template>
  <div >
    <VNav :currentNav="16" :currentStr="2"></VNav>
          ...
          <table style="width: 100%;margin-left: 2%">
            <tr>
              ...
              <td style="width: 50%" >
                ...
                <el-input  type="text" style="width: 60%"  readonly="readonly" v-model="lines.cityName"></el-input>
              </td>
            </tr>
            <tr style="">
              <td>
  ...
  export default {
    ...
    methods: {
      ...
      getThemes:function(){
        ...
        this.$axios.get("/line_group/init")
          ...
          .catch(failRespose => {
            ...
            //this.$router.push("/line_groupAdd");
          })
      ...
      sub() {
        ...
        this.$axios.post("/line_group/save", qs.stringify(this.lineGroup), config)
          .then(successReqponse => {
            alert("保存成功");
