   ...
   <div :style="{background:bg}">
     ...
     <el-main style="width: 70%;margin-left: 15%;background-color: white;margin-top: 2%" >
       <form >
         ...
         <ul class="el-upload-list el-upload-list--picture-card" v-show="imageShow" style="margin-top: 2%" >
           <li class="el-upload-list__item is-success"  >
             <img style="width: 100%; height: 100%" :src="strategy.strategyImg" />
       ...
       <p class="collect" style="margin-left: 40%;margin-top: 2%">
         <a class="btn" style="background-color: #b9ea43;float: inherit;" @click="back()"  ><i class="el-icon-back"></i>返回</a>
         <a class="btn" id="shoucang" style="background-color: #b9ea43;float: inherit;" @click="sub()"  ><i class="iconfont travel-iconfabu"></i>发布</a>
         <a class="btn" style="float: inherit;" @click="rinput()" ><i class="iconfont travel-iconzhongzhi" ></i>重置</a>
  ...
  export default {
    ...
    methods:{
      ...
      sub(){
        ...
        this.formData.append("strategyId",this.strategy.strategyId);
        this.formData.append("createTime",this.strategy.createTime);
        ...
        this.formData.append("scenicId",this.strategy.scenicId);
        this.formData.append("strategyImg",this.strategy.strategyImg);
      ...
      init() {
        ...
        this.$axios.get("/strategy/getstrategy?strategyId="+this.strategyId)
          .then(successReqponse => {
            ...
            this.scenicName=data.strategy.scenicName;
            this.scenicId=data.strategy.scenicId;
            this.content=data.strategy.strategyContent;
