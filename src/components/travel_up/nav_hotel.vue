                      ...
                      <div role="tabpanel" class="tab-pane active" id="popularity" >
                        <div class="row" style="margin-top: 2%" v-for="(va,index) in hotelList">
                          <div class="col-md-3"  v-for="hotel in va">
                            <router-link :to="{path:'hotel',query:{hotelId:hotel.hotelId}}"
                              style="    width: 90%;
    margin-left: 5%;">
                              <img :src="hotel.hotelImg" style="height: 148px" alt="">
  ...
  export default {
    ...
    methods:{
      ...
      dataListFn: function(index){
        ...
        this.$axios.post("hotel/hotel_list",qs.stringify(this.searchData),config)
          .then(result=>{
...
//根据点击页数请求数据
      ...
      init(){
        ...
        this.$axios.get("/hotel/nav_hotel_init")
