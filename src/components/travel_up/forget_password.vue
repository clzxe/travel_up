          ...
          <form  >
            ...
            <table style="margin-top: 25px;width: 100%">
              ...
              <tr>
                ...
                <td class="td_right">
                  <el-input type="password" id="userPassword" v-model="newPassword" @blur="checkPassword" name="userPassword" placeholder="请输入密码"></el-input>
                </td>
              </tr>
              <tr>
                <td class="td_left">
                  <label for="userPassword">确认密码密码</label>
                </td>
                <td class="td_right">
                  <el-input type="password" id="userPasswordAgain" v-model="againPassword" @blur="checkPasswordAgain" name="userPassword" placeholder="请输入密码"></el-input>
                </td>
              </tr>
              <tr>
                <td class="td_left">
                ...
                <td class="td_right check">
                  <button  class="submit" @click="register" >确定</button>
...
<script>
  ...
  export default {
    ...
    methods: {
      getEmailCode(){
        if(this.chenckMail()){
          this.$axios.get("user/getEmail?userMail="+this.registerForm.userMail)
            .then(response => {
              // alert(data.flag);
      ...
      register() {
        ...
        if(this.checkPassword()&&this.checkPasswordAgain()){
          var qs = require('querystring')
